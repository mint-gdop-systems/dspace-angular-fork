...
export interface BitstreamTableEntry {
  ...
  nameStripped: string,
  /**
   * The type of the Bitstream
   */
  type: string,
  /**
   * The status of the Bitstream
   */
  status: string,
  /**
  ...
  mapBitstreamsToTableEntries(bitstreams: Bitstream[]): BitstreamTableEntry[] {
    return bitstreams.map((bitstream) => {
      ...
      return {
        ...
        type: bitstream.firstMetadataValue('crvs.documentType'),
        status: bitstream.firstMetadataValue('crvs.document.status'),
