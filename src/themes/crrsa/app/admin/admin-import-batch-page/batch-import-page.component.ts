...
import { FileDropzoneNoUploaderComponent } from 'src/app/shared/upload/file-dropzone-no-uploader/file-dropzone-no-uploader.component';
...
export class BatchImportPageComponent {
  ...
  /**
   * The flag between proceed clicked and file uploaded 
   */
  isProcessing = false;
