...
describe('AdminDashboardPageComponent', () => {
  ...
  const mockBitstreamDataService = jasmine.createSpyObj(
  ...
  beforeEach(async () => {
    ...
    mockBitstreamDataService.findListByHref.and.returnValue(
      of({ hasSucceeded: true, payload: { totalElements: 20 } }),
    );
